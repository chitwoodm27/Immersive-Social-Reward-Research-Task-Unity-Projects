...
public class NISTcontroller : MonoBehaviour

{
    ...
    IEnumerator trialRun()
    {
        ...
        eyeTracker.setFilePath("C:\\NIST\\EyeTrackingdata\\" + sysDate + sysTime + "\\");
        ...
        string docPath = @"C:\NIST\LRdata\"; //assign the location that we want the file saved
        ...
        {
            File.WriteAllLines(Path.Combine(docPath, "NIST_LR" + sysDate + sysTime + ".txt"), results);
        }
